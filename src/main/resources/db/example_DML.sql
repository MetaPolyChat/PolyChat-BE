...
-- TBL_INTEREST 테이블에 목업 데이터 삽입
INSERT INTO TBL_INTEREST (INTEREST_ID, INTEREST_NAME)
VALUES
    (1, '스포츠'),
    (2, '음악'),
    (3, '여행'),
...
-- TBL_USER_INTEREST 테이블에 목업 데이터 삽입
INSERT INTO TBL_USER_INTEREST (REF_INTEREST_ID, USER_ID, INTEREST_ID)
VALUES
    (1, 1, 1), -- 유저 1 관심사: 스포츠
    (2, 1, 3), -- 유저 1 관심사: 여행
    (3, 2, 2), -- 유저 2 관심사: 음악
